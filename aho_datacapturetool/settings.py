...
ALLOWED_HOSTS = ['localhost','af-aho-datacapturetool-noauth.azurewebsites.net']
...
SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_KEY = os.environ['SOCIAL_AUTH_AZUREAD_OAUTH2_KEY']
SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_SECRET =  os.environ['SOCIAL_AUTH_AZUREAD_OAUTH2_SECRET']
